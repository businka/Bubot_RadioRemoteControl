...
To run from the commands line with a specific port with a loop-back,
...
class Test_asyncio(unittest.TestCase):
    ...
    def test_asyncio(self):
        ...
        self.loop.run_forever()        self.assertEqual(b''.join(received), TEXT)
...
if __name__ == '__main__':
    ...
    sys.argv[1:] = ['-v']
    # When this module is executed from the commands-line, it runs all its tests
    unittest.main()